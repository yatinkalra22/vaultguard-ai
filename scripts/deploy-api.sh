...
echo "  2. Add Redis add-on for Bull queues: railway add redis"
echo "  3. Update FRONTEND_URL to Vercel production URL"
echo "  4. Update Auth0 callback URLs with Railway domain"
